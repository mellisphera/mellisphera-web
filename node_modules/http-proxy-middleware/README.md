...
// ***REMOVED***:3000/api/foo/bar -> http://www.example.org/api/foo/bar
```
...
var options = {
        ...
        router: {
            ...
            // override target 'http://www.example.org' to '***REMOVED***:8000'
            'dev.localhost:3000' : '***REMOVED***:8000'
        }
    };
...
* **option.router**: object/function, re-target `option.target` for specific requests.
    ...
    router: {
        'integration.localhost:3000' : '***REMOVED***:8001',  // host only
        'staging.localhost:3000'     : '***REMOVED***:8002',  // host only
        'localhost:3000/api'         : '***REMOVED***:8003',  // host + path
        '/rest'                      : '***REMOVED***:8004'   // path only
    }
