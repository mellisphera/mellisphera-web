...
const isProductionLikeMode = options => {
	return options.mode === "***REMOVED***" || !options.mode;
};
...
class WebpackOptionsDefaulter extends OptionsDefaulter {
	constructor() {
		...
		// TODO webpack 5 add `moduleIds: "size"` default for ***REMOVED***
		...
		// TODO webpack 5 add `chunkIds: "size"` default for ***REMOVED***
