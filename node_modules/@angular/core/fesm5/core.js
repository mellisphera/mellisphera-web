 ...
 * you don't add them to ensure that `wtfLeave` gets called. In ***REMOVED*** `wtfLeave` is a noop and
...
var ApplicationRef = /** @class */ (function () {
    ...
    ApplicationRef.prototype.bootstrap = function (componentOrFactory, rootSelectorOrNode) {
        ...
        if (isDevMode()) {
            this._console.log("Angular is running in the development mode. Call enableProdMode() to enable the ***REMOVED*** mode.");
        }
        return compRef;
    };
    /**
 ...
 *
 * The idea is that unless we are doing ***REMOVED*** build where we explicitly
