...
exports.baseBuildCommandOptions = [
    {
        ...
        type: String,
        default: 'development',
        aliases: ['t', { 'dev': 'development' }, { 'prod': '***REMOVED***' }],
    ...
    },
    {
        ...
        type: Boolean,
        default: true,
        description: 'Extract all licenses in a separate file, in the case of ***REMOVED*** builds only.'
    },
    {
    ...
    },
    {
        ...
        default: true,
        aliases: ['sw'],
        description: 'Generates a service worker config for ***REMOVED*** builds, if the app has '
...
const BuildCommand = Command.extend({
    ...
    run: function (commandOptions) {
        ...
        const doAppShell = commandOptions.target === '***REMOVED***' &&
