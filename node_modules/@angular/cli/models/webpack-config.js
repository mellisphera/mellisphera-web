...
class NgCliWebpackConfig {
    ...
    validateBuildOptions(buildOptions) {
        ...
        if (buildOptions.target !== 'development' && buildOptions.target !== '***REMOVED***') {
            throw new Error("Invalid build target. Only 'development' and '***REMOVED***' are available.");
        }
        if (buildOptions.buildOptimizer
            && !(buildOptions.aot || buildOptions.target === '***REMOVED***')) {
    ...
    addTargetDefaults(buildOptions) {
        ...
        const buildOptimizerDefault = {
            buildOptimizer: buildOptions.target == '***REMOVED***' && buildOptions.aot !== false
