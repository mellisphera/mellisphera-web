...
* @property {string} pphName Name of the post-***REMOVED*** house that manages the Edit ordered.
...
Example: &quot;MPAA&quot;
* @property {string[]} pphNames Name of the post-***REMOVED*** houses that manage the Avail.
Not part of EMA Specs.
...
* @property {string[]} pphNames Name of the post-***REMOVED*** houses that manage the Edit.
* @property {string} episodeNumber The number assigned to the episode within a season.
