import { CalendarEvent, DayViewEvent, DayViewHour, DayViewHourSegment, ViewPeriod, WeekDay, WeekViewAllDayEvent } from 'calendar-utils';
...
export declare const trackByHourSegment: (index: number, segment: DayViewHourSegment) => string;
export declare const trackByHour: (index: number, hour: DayViewHour) => string;
export declare const trackByDayOrWeekEvent: (index: number, weekEvent: WeekViewAllDayEvent | DayViewEvent) => string | number | CalendarEvent<any>;
