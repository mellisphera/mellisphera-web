...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        jasmine: {
            ...
            ***REMOVED***: {
                src: ['test/browser/less/***REMOVED***/*.less'],
                options: {
                    helpers: 'test/browser/runner-***REMOVED***-options.js',
                    specs: 'test/browser/runner-***REMOVED***-spec.js',
                    outfile: 'tmp/browser/test-runner-***REMOVED***.html'
                }
            },
            modifyVars: {
        ...
        'saucelabs-jasmine': {
            all: {
                options: {
                    urls: ["filemanager-plugin","visitor-plugin","pre-processor-plugin","post-processor-plugin","post-processor", "global-vars", "modify-vars", "***REMOVED***", "rootpath-relative",
                           "rootpath", "relative-urls", "browser", "no-js-errors", "legacy", "strict-units"
                    ].map(function(testName) {
                        return "***REMOVED***:8081/tmp/browser/test-runner-" + testName + ".html";
                    }),
