@import "***REMOVED***:8081/test/browser/less/modify-this.css";
@import "***REMOVED***:8081/test/browser/less/modify-again.css";
.modify {
  my-url: url("***REMOVED***:8081/test/browser/less/a.png");
}
.modify {
  my-url: url("***REMOVED***:8081/test/browser/less/b.png");
}
.gray-gradient {
...
@font-face {
  ...
  src: local(Futura-Medium), url(***REMOVED***:8081/test/browser/less/fonts.svg#MyGeometricModern) format("svg");
  not-a-comment: url(//z);
}
#shorthands {
...
#misc {
  background-image: url(***REMOVED***:8081/test/browser/less/images/image.jpg);
}
#data-uri {
...
.comma-delimited {
  background: url(***REMOVED***:8081/test/browser/less/bg.jpg) no-repeat, url(***REMOVED***:8081/test/browser/less/bg.png) repeat-x top left, url(***REMOVED***:8081/test/browser/less/bg);
}
.values {
  url: url('***REMOVED***:8081/test/browser/less/Trebuchet');
}
#data-uri {
  uri: url('***REMOVED***:8081/test/data/image.jpg');
}
#data-uri-guess {
  uri: url('***REMOVED***:8081/test/data/image.jpg');
}
#data-uri-ascii {
  uri-1: url('***REMOVED***:8081/test/data/page.html');
  uri-2: url('***REMOVED***:8081/test/data/page.html');
}
#data-uri-toobig {
  uri: url('***REMOVED***:8081/test/data/data-uri-fail.png');
}
#svg-functions {
