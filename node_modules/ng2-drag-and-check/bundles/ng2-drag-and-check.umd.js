(function (global, factory) {
	...
	(factory((global['ng2-drag-and-check'] = {}),global.ng.core));
...
var DragAndCheckDirective = (function () {
    ...
    DragAndCheckDirective.prototype.verifyMoveOnX = function () {
        var /** @type {?} */ boundaries = this.el.nativeElement.getBoundingClientRect();
        var /** @type {?} */ horizontalMove = this.tempTrans.x - this.currentTrans.x;
        var /** @type {?} */ allowedLeftOffset = this.allowedOffsets.getLeft(this.el.nativeElement, this.handle);
        ...
        var /** @type {?} */ allowedRightOffset = this.allowedOffsets.getRight(this.el.nativeElement, this.handle);
        var /** @type {?} */ windowWidth = document.documentElement.clientWidth;
    ...
    DragAndCheckDirective.prototype.verifyMoveOnY = function () {
        var /** @type {?} */ boundaries = this.el.nativeElement.getBoundingClientRect();
        var /** @type {?} */ windowHeight = document.documentElement.clientHeight;
        var /** @type {?} */ verticalMove = this.tempTrans.y - this.currentTrans.y;
        var /** @type {?} */ allowedTopOffset = this.allowedOffsets.getTop(this.el.nativeElement, this.handle);
        ...
        var /** @type {?} */ allowedBottomOffset = this.allowedOffsets.getBottom(this.el.nativeElement, this.handle);
 ...
 * @nocollapse
 */
DragAndCheckDirective.ctorParameters = function () { return [
...
DragAndCheckDirective.propDecorators = {
    ...
    'allowedOffsets': [{ type: core.Input },],
...
var Offsets = (function () {
    ...
    Offsets.prototype.computeHANDLE = function (el, handle) {
        ...
        var /** @type {?} */ contentHeight = el.getBoundingClientRect().height;
...
var DragAndCheckModule = (function () {
    function DragAndCheckModule() {
    }
    return DragAndCheckModule;
}());
 ...
 * @nocollapse
 */
DragAndCheckModule.ctorParameters = function () { return []; };

exports.DragAndCheckModule = DragAndCheckModule;
...
//# sourceMappingURL=ng2-drag-and-check.umd.js.map
