          ...
          if (error.originalStack && Error === ZoneAwareError) {
            ...
            while (frames.length) {
              ...
              if (/:\d+:\d+/.test(frame)) {
                ...
                // Chrome: at Zone.run (***REMOVED***:9876/base/build/lib/zone.js:100:24)
                // FireFox: Zone.prototype.run@***REMOVED***:9876/base/build/lib/zone.js:101:24
                // Safari: run@***REMOVED***:9876/base/build/lib/zone.js:101:24
