...
var location = '***REMOVED***:8081/foo/123'
...
test('Test simple url string', function(t) {
	...
	t.equal(resolved, '***REMOVED***:8081/api/foo', 'Url should be correct')
	t.end()
...
test('Test full url object', function(t) {
	var testUrl = {
		host: "localhost:8081",
		hostname: "localhost",
		href: "***REMOVED***:8081/api/foo?bar=baz",
		method: "GET",
	...
	var resolved = url.resolve(location, request._opts.url)
	t.equal(resolved, '***REMOVED***:8081/api/foo?bar=baz', 'Url should be correct')
	t.end()
})
...
test('Test page with \'file:\' protocol', function (t) {
	...
	t.equal(resolved, '***REMOVED***:3000/bar', 'Url should be correct')
	t.end()
})
...
test('Test relative path in url', function(t) {
	...
	var resolved = url.resolve(location, request._opts.url)
	t.equal(resolved, '***REMOVED***:8081/foo/bar', 'Url should be correct')
	t.end()
})
