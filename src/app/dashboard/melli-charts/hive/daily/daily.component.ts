...
export class DailyComponent implements OnInit, AfterViewInit {
  ...
  constructor(private renderer: Renderer2,
    ...
    this.typeData = [
      ...
      { name: 'TEMP_EXT_MAX', id: 'TEMP_EXT_MAX', unit: 'T', origin: 'DEVICE', class: 'item-type', icons: './assets/ms-pics/tmax_cb.png' },
      { name: 'TEMP_EXT_MIN', id: 'TEMP_EXT_MIN', unit: 'T', origin: 'DEVICE', class: 'item-type', icons: './assets/ms-pics/tmin_cb.png' },
